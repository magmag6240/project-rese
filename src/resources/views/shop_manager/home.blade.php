...
<div class="shop-manager-home">
    ...
    <div class="shop-manage-page-list">
        ...
        <div class="page-group">
            <button class="page-group-button"><a class="shop-manage-link" href="{{ route('shop_manager.qr_code') }}">お客様来店時予約照会</a></button>
            <p class="shop-manage-text">お客様来店時、予約時に発行されるQRコードを読み取る</p>
        </div>
        @endif
        @if(!is_null($shop))
        <div class="page-group">
