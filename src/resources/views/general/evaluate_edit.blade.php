            ...
            <div class="form-edit">
                <div class="form-star">
                    ...
                    <div class="form-star-group">
                        <input class="star-input" type="radio" id="star_5" name="star_id" value="5" {{ old('star_id','5') == '5' ? 'checked' : '' }}>
                        <label class="star-label" for="star_5">★</label>
                        <input class="star-input" type="radio" id="star_4" name="star_id" value="4" {{ old('star_id','4') == '4' ? 'checked' : '' }}>
                        <label class="star-label" for="star_4">★</label>
                        <input class="star-input" type="radio" id="star_3" name="star_id" value="3" {{ old('star_id','5') == '3' ? 'checked' : '' }}>
                        <label class="star-label" for="star_3">★</label>
                        <input class="star-input" type="radio" id="star_2" name="star_id" value="2" {{ old('star_id','5') == '2' ? 'checked' : '' }}>
                        <label class="star-label" for="star_2">★</label>
                        <input class="star-input" type="radio" id="star_1" name="star_id" value="1" {{ old('star_id','5') == '1' ? 'checked' : '' }}>
                ...
                <div class="form-image">
                    ...
                    <div class="form-image-content">
                        ...
                        <input class="input-files" type="file" name="image_url" value="{{ old('image_url') }}">
                    </div>
